class MeetingRoomsController < ApplicationController
  ...
  def meeting_room_params
    params.require(:meeting_rooms).permit(:hourly_price, :n_people, :user_id, :morning, :afternoon, :saturday_open, :sunday_open, :location, :layout, :description, :adress, :name, :photo, :photo_cache)
end
